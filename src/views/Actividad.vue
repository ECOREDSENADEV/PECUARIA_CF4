  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Ángulos de punción
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Identificar los diversos procedimientos que hacen parte de los ángulos de punción.
            .col-auto
              a.boton.boton--b(:href="obtenerLink('/actividades/AD1_CF4/story.html')" target="_blank")
                span Realizar
